  ...
  return (
    <section id="projects" className="py-20 relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {Object.entries(projectsByCategory).map(([category, categoryProjects]) => (
          <div key={category} className="mb-20">
            <CategoryHeader category={category} count={categoryProjects.length} />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {categoryProjects.map((project, index) => {
                ...
                return (
                  <div
                    key={globalIndex}
                    className="perspective-container transition-all duration-1000 ease-out opacity-100 translate-y-0"
                  ...
                  >
                    <div
                      className={`project-card-animated card-hover rounded-xl overflow-hidden shadow-xl transition-all duration-500 
                                 ${activeProject === globalIndex ? 'scale-[1.02]' : 'scale-100'}`}
                    >
                      {/* Project Image */}
      ...
      <style>{`
        ...
        /* Project card with animated border on hover */
        ...
        .project-card-animated::before {
          ...
          background: conic-gradient(
            ...
            transparent 0deg,
            transparent 45deg,
            rgba(108, 99, 255, 0.6) 90deg,
            rgba(46, 196, 182, 0.8) 135deg,
            rgba(255, 215, 0, 0.6) 180deg,
            rgba(147, 51, 234, 0.8) 225deg,
            rgba(108, 99, 255, 0.6) 270deg,
            transparent 315deg,
            transparent 360deg
          );
          border-radius: 50%;
        ...
        /* Inner mask for border-only effect */
        .project-card-animated::after {
          content: '';
          position: absolute;
          top: 2px;
          left: 2px;
        ...
        .project-card-animated:hover .project-image-container::after {
          left: 125%;
        }
        ...
        /* Project link buttons with hover effects */
        .project-link {
          position: relative;
          overflow: hidden;
          transition: all 0.3s ease;
